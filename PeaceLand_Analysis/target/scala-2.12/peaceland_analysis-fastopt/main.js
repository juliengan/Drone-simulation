...
function $s_Lanalysis_Analysis__main__AT__V(args) {
  var this$1 = $m_Lanalysis_Analysis$();
  this$1.htmlUpdate__V()
}
/** @constructor */
function $c_Lanalysis_Analysis$() {
  /*<skip>*/
}
$c_Lanalysis_Analysis$.prototype = new $h_O();
$c_Lanalysis_Analysis$.prototype.constructor = $c_Lanalysis_Analysis$;
/** @constructor */
function $h_Lanalysis_Analysis$() {
  /*<skip>*/
}
$h_Lanalysis_Analysis$.prototype = $c_Lanalysis_Analysis$.prototype;
$c_Lanalysis_Analysis$.prototype.htmlUpdate__V = (function() {
  document.addEventListener("DOMContentLoaded", ((arg1$2) => {
    $m_Lanalysis_Analysis$().setupUI__V()
  }))
});
$c_Lanalysis_Analysis$.prototype.setupUI__V = (function() {
  var button = document.createElement("button");
  button.textContent = "Click me!";
  button.addEventListener("click", ((arg1$2) => {
    $m_Lanalysis_Analysis$().addClickedMessage__V()
  }));
  document.body.appendChild(button);
  this.appendPar__Lorg_scalajs_dom_Node__T__V(document.body, "Hello World")
});
$c_Lanalysis_Analysis$.prototype.addClickedMessage__V = (function() {
  this.appendPar__Lorg_scalajs_dom_Node__T__V(document.body, "You clicked the button!")
});
$c_Lanalysis_Analysis$.prototype.appendPar__Lorg_scalajs_dom_Node__T__V = (function(targetNode, text) {
  var parNode = document.createElement("p");
  parNode.textContent = text;
  targetNode.appendChild(parNode)
});
var $d_Lanalysis_Analysis$ = new $TypeData().initClass({
  Lanalysis_Analysis$: 0
}, false, "analysis.Analysis$", {
  Lanalysis_Analysis$: 1,
  O: 1
});
$c_Lanalysis_Analysis$.prototype.$classData = $d_Lanalysis_Analysis$;
var $n_Lanalysis_Analysis$;
function $m_Lanalysis_Analysis$() {
  if ((!$n_Lanalysis_Analysis$)) {
    $n_Lanalysis_Analysis$ = new $c_Lanalysis_Analysis$()
  };
  return $n_Lanalysis_Analysis$
}
/** @constructor */
...
$s_Lanalysis_Analysis__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
