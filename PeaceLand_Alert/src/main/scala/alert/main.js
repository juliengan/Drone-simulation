...
function $s_Lalert_Alert__main__AT__V(args) {
  $m_Lalert_Alert$().main__AT__V(args)
}
/** @constructor */
function $c_Lalert_Alert$() {
  /*<skip>*/
}
$c_Lalert_Alert$.prototype = new $h_O();
$c_Lalert_Alert$.prototype.constructor = $c_Lalert_Alert$;
/** @constructor */
function $h_Lalert_Alert$() {
  /*<skip>*/
}
$h_Lalert_Alert$.prototype = $c_Lalert_Alert$.prototype;
$c_Lalert_Alert$.prototype.appendPar__Lorg_scalajs_dom_Node__T__V = (function(targetNode, text) {
...
$c_Lalert_Alert$.prototype.$classData = $d_Lalert_Alert$;
var $n_Lalert_Alert$;
function $m_Lalert_Alert$() {
  if ((!$n_Lalert_Alert$)) {
    $n_Lalert_Alert$ = new $c_Lalert_Alert$()
  };
  return $n_Lalert_Alert$
}
/** @constructor */
...
$s_Lalert_Alert__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
